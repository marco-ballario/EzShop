...
- [Use case diagram and use cases](#use-case-diagram-and-use-cases)
    ...
    + [Use case 1, UC1 - Register new customer](#use-case-1-uc1-register-new-customer)
        + [Scenario 1.1](#scenario-11)
        + [Scenario 1.2](#scenario-12)
        + [Scenario 1.3](#scenario-13)
    + [Use case 2, UC2 - Pay products](#use-case-2-uc2-pay-products)
        + [Scenario 2.1](#scenario-21)
        + [Scenario 2.2](#scenario-22)
    + [Use case 3, UC3 - Verify products deadline](#use-case-3-uc3-verify-products-deadline)
        + [Scenario 3.1](#scenario-31)
        + [Scenario 3.2](#scenario-32)
    + [Use case 4, UC4 - Monitor products](#use-case-4-uc4-monitor-products)
        + [Scenario 4.1](#scenario-41)
        + [Scenario 4.2](#scenario-42)
    + [Use case 5, UC5 - Monitor shop balance](#use-case-5-uc5-monitor-shop-balance)
        + [Scenario 5.1](#scenario-51)
    + [Use case 6, UC6 - Update products quantity](#use-case-6-uc6-update-products-quantity)
        + [Scenario 6.1](#scenario-61)
        + [Scenario 6.2](#scenario-62)
    + [Use case 7, UC7 - Login](#use-case-7-uc7-login)
        + [Scenario 7.1](#scenario-71)
        + [Scenario 7.2](#scenario-72)
    + [Use case 8, UC8 - Apply discount](#use-case-8-uc8-apply-discount)
        + [Scenario 8.1](#scenario-81)
        + [Scenario 8.2](#scenario-82)
    + [Use case 9, UC9 - Start shift](#use-case-9-uc9-start-shift)
